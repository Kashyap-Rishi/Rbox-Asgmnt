...
import ResetDarkIcon from "../../icons/svg/reset-dark";
  ...
  return (
    <Container
      style={{
        padding: "15px",
        minHeight: "100vh",
        borderRight: `1px solid ${theme?.palette?.threads?.borderColor}`,
    ...
    >
      ...
      >
        ...
        <Box
          sx={{
            ...
            backgroundColor: theme?.palette?.threads?.resetBackground,
            borderRadius: "4px",
          }}
        >
          {theme.palette.mode === "light" ? <ResetIcon /> : <ResetDarkIcon />}
        </Box>
      </Box>
      ...
      >
        ...
        <Typography sx={{ color: theme?.palette?.threads?.inboxText }}>
          Inboxes selected
        </Typography>
      </Box>
