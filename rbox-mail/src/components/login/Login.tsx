...
import { Box, Typography, Paper, Button, SvgIcon, ButtonProps } from '@mui/material';
...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography
          sx={{ fontWeight: 600, fontSize: '20px', lineHeight: '31px', color: '#fff', marginBottom: '24px' }}
        >
        ...
        <Button
          variant="contained"
          sx={{
            backgroundImage: 'linear-gradient(180deg, #4B63DD 0%, #0524BF 100%)',
            borderRadius: '4px',
            width: '195px',
            height: '48px',
            fontSize: '14px',
        ...
        >
          ...
          <Typography component="span" sx={{ color: '#C1C2C5', cursor: 'pointer', marginLeft: 1 }}>
            Sign in
          </Typography>
        </Typography>
      </Paper>
